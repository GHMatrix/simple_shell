...
/**
 * output_alias - Program adds, removes or shows aliases
 * @data: struct for the program's data
 * @alias: name of the alias to be printed
 * Return: zero if success, or other number if its declared in the args
 */
 ...
 */
char *get_alias(prog_data *data, char *name)
{
	int i, alias_length;
